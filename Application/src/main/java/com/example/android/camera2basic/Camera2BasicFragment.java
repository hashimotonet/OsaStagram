...
//            Image raw = reader.acquireLatestImage();
    ...
    private CameraCaptureSession.CaptureCallback mCaptureCallback
        ...
        private void process(CaptureResult result) {
            ...
            //Log.i(Camera2BasicFragment.TAG, "mState = " + mState);
...
//        }
    ...
    private void captureStillPicture() {
        Log.i("IMPORTANT","captureStillPicture()");
        try {
            final Activity activity = getActivity();

            Log.i(TAG,"activity = " + activity + " : mCameraDevice = " + mCameraDevice);
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                    ...
                    // マトリックスを生成
                    Matrix matrix = new Matrix();
                    matrix = getRotatedMatrix(mFile, matrix);

                    if (mFile != null) {
                        Log.i("IMPORTANT", "mFile.exists() : " + mFile.exists());
                    }

                    // 修正したファイルを取得
                    mFile = getTemporaryFile(mFile, matrix);
